                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 grid-cols-1">
                            ...
                            <div className="group w-full h-full">
                                <div className="relative h-full">
                                    <img src="../../public/contactusimage.png"
                                         ...
                                         className="w-full h-full object-contain lg:rounded-l-2xl rounded-2xl bg-blend-multiply" style={{backgroundColor:'#C6DBCF'}}/>
                                    ...
                                    <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                        <div className="bg-white rounded-lg p-6 block">
                                            ...
                                            <a href="javascript:;" className="flex items-center">
                                                ...
                                                <h5 className="text-black text-base font-normal leading-6 ml-5">Gaming bug Adresi</h5>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                            <h2 className=" heavy-font font-manrope text-4xl font-semibold leading-10 mb-11 text-black">Send us a message!</h2>
                            <input type="text"
