        ...
        <section className="bg-white mt-12" >
            <div id="home" className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    <a href="#" className="icon-facebook text-gray-400 hover:text-gray-500">
                    ...
                    <a href="#" className="icon-instagram text-gray-400">
                    ...
                    <a href="#" className="icon-discord text-gray-400 hover:text-gray-500">
